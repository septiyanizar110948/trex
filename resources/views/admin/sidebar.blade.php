    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item ">
            ...
            <ul id="users-nav" class="nav-content {{ request()->routeis('user') ? '' : 'collapsed' }}" data-bs-parent="#sidebar-nav">
                ...
                <li class="nav-item ">
                    <a class="nav-link  {{ request()->routeis('travel.create') ? 'active' : 'collapsed' }}" data-bs-target="#users-nav" data-bs-toggle="collapse"
                        href="{{ url('#') }}">
                        <i class="ri-admin-fill"></i><span>Users</span><i
                            class="bi bi-chevron-down ms-auto"></i>
                    </a>
                    <ul id="users-nav" class="nav-content {{ request()->routeis('travel') ? '' : 'collapsed' }}" data-bs-parent="#sidebar-nav">
                        <li>
